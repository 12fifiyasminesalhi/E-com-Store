...
<head>
	...
	<!-- title -->
	<title>Parapharme - Slider Version</title>

	<!-- favicon -->
	<link rel="shortcut icon" type="image/png" href="assets/img/faviconn.jpg">
	<!-- google font -->
			...
			<div class="row">
				<div class="col-lg-12 col-sm-12 text-center">
					<div class="main-menu-wrap">
						...
						<div class="site-logo">
							<a href="/">
								<h1 style="color: aliceblue;font-size:18px; ">❤️Parapharme</h1>
							</a>
						</div>
						<!-- logo -->
                        ...
                        @endguest
								...
								<li><a href="#categories ">catégories</a>
									<ul class="sub-menu">
										...
										<li><a href="#categories">Equipement medical</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box get-in-touch" id="contact">
						...
						<ul>
							<li>Bordj El Kiffan, Alger.</li>
							<li>support@parapharme.com</li>
							<li>+213 774677607</li>
						</ul>
					</div>
				</div>
